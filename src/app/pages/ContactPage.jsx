        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-100 border border-[rgba(0,0,0,0.2)] rounded-3xl p-8">
              ...
              <p className="text-base text-black mb-6 text-center font-semibold">+91 98765 43210</p>
              <p className="text-base text-black mb-6 text-center leading-relaxed">
            ...
            <div className="bg-gray-100 border border-[rgba(0,0,0,0.2)] rounded-3xl p-8">
              ...
              <p className="text-base text-black mb-6 text-center font-semibold">9876543210</p>
              <p className="text-base text-black mb-6 text-center leading-relaxed">
          ...
          <div className="bg-linear-to-br from-[#273a69] via-[#15203b] to-[#060a12] border border-[rgba(0,0,0,0.2)] rounded-3xl p-8 lg:p-12">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col justify-between">
                <div>
                  <a href="/consultation">
                    <button className="w-full bg-[#6cc93e] hover:bg-[#5ab84f] text-white font-semibold py-6 px-8 rounded-2xl transition-colors flex items-center justify-center gap-3 mb-6 cursor-pointer">
                  ...
                  <div className=" pt-6 space-y-4 mt-12">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xl text-white font-semibold">+91 9876543210</span>
                    </div>
                    <div className="flex items-center gap-3">
